...
/*   Updated: 2024/12/13 10:37:58 by vkuznets         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
ClapTrap::ClapTrap(const std::string &name) :  _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0) {std::cout << "Constructor with name " << name << " called" << std::endl; };
...
void	ClapTrap::attack(const std::string &target) {
	...
	if (!_energyPoints) {
		std::cout << "ClapTrap " << _name << " doesn't have enough energy points! Remaining energy: "
